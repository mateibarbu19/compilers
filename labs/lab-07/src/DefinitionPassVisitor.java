public class DefinitionPassVisitor implements ASTVisitor<Void> {
    ...
    public Void visit(VarDef varDef) {
        ...
        // DONE 1: Reținem informația de tip în simbolul nou creat.
        // Mai întâi căutăm tipul variabilei.
        var searchedType = currentScope.lookup(type.getToken().getText());
        // Semnalăm eroare dacă nu există.
        if (!(searchedType instanceof TypeSymbol)) {
        ...
        // variabilei
        symbol.setType((TypeSymbol) searchedType);
    ...
    public Void visit(FuncDef funcDef) {
        ...
        // DONE 1: Reținem informația de tip în simbolul nou creat.
        // Mai întâi căutăm tipul funcției.
        var searchedType = currentScope.lookup(type.getToken().getText());
        // Semnalăm eroare dacă nu există.
        if (!(searchedType instanceof TypeSymbol)) {
            ASTVisitor.error(type.getToken(),
        ...
        functionSymbol.setType((TypeSymbol) searchedType);
