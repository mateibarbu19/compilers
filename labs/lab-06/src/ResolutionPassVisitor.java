public class ResolutionPassVisitor implements ASTVisitor<Void> {
    ...
    public Void visit(Assign assign) {
        /*
         * DONE 3: Verificăm dacă membrul din stânga este într-adevăr
         * o variabilă sau este o funcție, fiind eroare. Puteți folosi instanceof.
         */

        var sym = assign.id.getScope().lookup(assign.id.getToken().getText());
        if (!(sym instanceof IdSymbol) || (sym instanceof FunctionSymbol)) {
    ...
    public Void visit(Call call) {
        /*
         * DONE 3: Verificăm dacă funcția există în scope. Nu am putut face
         ...
         */
        var sym = call.id.getScope().lookup(call.id.getToken().getText());
